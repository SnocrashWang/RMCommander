...
def main():
    ...
    while True:
        ...
        red_action = {
            robot_id: default_action.copy() for robot_id, robot in env.env.robots.items() if robot.team == GameTeam.RED
        }
        blue_action = {
            robot_id: default_action.copy() for robot_id, robot in env.env.robots.items() if robot.team == GameTeam.BLUE
        }
